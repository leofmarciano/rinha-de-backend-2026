...
<!-- BENCH-RESULTS:START -->
**Última execução:** commit `d86a55c` em `2026-05-04 10:23 UTC`. [Workflow run](https://github.com/leofmarciano/rinha-de-backend-2026/actions/runs/25313617332).
...
```json
{
  ...
  "scoring": {
    "breakdown": {
      ...
      "true_positive_detections": 24034,
      "true_negative_detections": 30019,
      "http_errors": 0
    },
    "failure_rate": "0%",
    "weighted_errors_E": 1,
    "error_rate_epsilon": 1.9e-05,
    "p99_score": {
      "value": 3000,
      "cut_triggered": false
    },
