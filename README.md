...
<!-- BENCH-RESULTS:START -->
**Última execução:** commit `45fdb48` em `2026-05-04 13:16 UTC`. [Workflow run](https://github.com/leofmarciano/rinha-de-backend-2026/actions/runs/25320985261).
...
```json
{
  ...
  "scoring": {
    "breakdown": {
      ...
      "true_positive_detections": 24035,
